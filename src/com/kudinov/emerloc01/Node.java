...
public class Node {
    ...
    private Pipe pipe;
    private NodeType nodeType = NodeType.PIPELINE_BLOCK;
    private int i;
    private int j;
    ...
    public void setRandomAsHouseBlock() {
        if (random.nextInt(2) == 1)
            this.nodeType = NodeType.HOUSE_BLOCK;
    }
    ...
    public boolean isHouse() {
        return nodeType == NodeType.HOUSE;
    }

    public boolean isPipelineBlock() {
        return nodeType == NodeType.PIPELINE_BLOCK ? true : false;
    }

    public boolean isPipeline() {
        return nodeType == NodeType.PIPELINE ? true : false;
    }
