...
import static com.kudinov.emerloc01.Display.changeStage;
import static com.kudinov.emerloc01.Display.van;
...
public class GameField extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (!Display.onEmergency) {
            g.drawImage(van, structure.getVan().getJ(), structure.getVan().getI(), this);
        }
    }
